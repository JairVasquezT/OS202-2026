...
**Réduction du Surcoût de Communication**: Synchroniser uniquement les masses et centres de masse des nœuds (O(N log N) scalaires) au lieu des positions complètes de tous les corps (O(N × 3) réels). Cette réduction dramatique du volume de données communiquées améliore significativement la scalabilité.
